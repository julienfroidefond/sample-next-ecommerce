  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-500">
        ...
        avant de rendre. Le serveur attend donc la fin du fetch avant
        d&apos;envoyer le HTML — la première réponse contient déjà toute la
        liste. Sans{" "}
        <code className="rounded bg-zinc-200 px-1 dark:bg-zinc-700">await</code>
        , tu enverrais une promise (objet) au lieu des données, et le rendu
        planterait ou serait vide. Par ailleurs, tout{" "}
        <strong>l&apos;arbre est bloquant</strong> : si des composants enfants
        font eux aussi des{" "}
        <code className="rounded bg-zinc-200 px-1 dark:bg-zinc-700">await</code>
        , le serveur attend que tous soient résolus avant d&apos;envoyer le HTML
        — pas de stream par sous-partie tant qu&apos;on n&apos;utilise pas des
        boundaries (Suspense, etc.).
      </p>
