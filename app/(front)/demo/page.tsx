    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 flex flex-col gap-6 sm:flex-row sm:gap-8">
        ...
        <section className="rounded-lg border border-zinc-200 p-6 dark:border-zinc-700">
          ...
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
            Exemple d&apos;utilisation du repository (Server Component).
          </p>
          <Link
            href="/demo/get-products"
            className="mt-3 inline-block rounded bg-zinc-900 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
          >
            Voir l&apos;exemple
          </Link>
        ...
        <section className="rounded-lg border border-zinc-200 p-6 dark:border-zinc-700">
          ...
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
            Client Component avec <code className="rounded bg-zinc-200 px-1 dark:bg-zinc-700">use(promise)</code>.
          </p>
          <Link
            href="/demo/use-get-products"
            className="mt-3 inline-block rounded bg-zinc-900 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
          >
            Voir l&apos;exemple
          </Link>
        ...
        <section className="rounded-lg border border-zinc-200 p-6 dark:border-zinc-700">
          ...
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
            Cache serveur d&apos;une fonction coûteuse avec timing.
          </p>
          <Link
            href="/demo/unstable-cache"
            className="mt-3 inline-block rounded bg-zinc-900 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
          >
            Voir l&apos;exemple
          </Link>
